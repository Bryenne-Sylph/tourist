...
windower.register_event('outgoing chunk', function(id, data)
	...
	if id == 0x037 then
		...
		elseif (current_item == 28540 or current_item == 17040 or current_item == 17587 or current_item == 17588 or current_item == 4181) then
			-- 28540: Warp Ring, 17040: Warp Cudgel, 17587: Treat Staff II, 17588: Trick Staff II, 4181: scroll of instant warp
